...
import org.laybe.whichveggie.activities.BaseActivity;
...
public abstract class BaseFragment extends Fragment implements FragmentView {
	...
	protected AppCompatActivity getAppCompatActivity() {
		...
		throw new IllegalStateException("Activity of this fragment is not an AppCompatActivity.");
	}
	...
	public void onAttach(Activity activity) {
		...
		if (activity instanceof BaseActivity)
			...
			fragmentGraph = ((WhichVeggieApp) activity.getApplication()).createScopedGraph(getModules().toArray());
